...
| `/publicar` | Publica na Hostinger SOZINHO (publicador automático, sem abrir o hPanel) + página-capa da proposta + HTTPS validado |
...
Claude Cowork · extensão Claude in Chrome · conectores Gmail e Google Drive · hospedagem Hostinger (plano M+) · Python (para o dashboard e o publicador) · Windows ou Mac.
